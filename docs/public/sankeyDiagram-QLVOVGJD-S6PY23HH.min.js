...
`).trim(),"prepareTextForParsing"),ue=y(t=>`.label {
    ...
    }`,"getStyles"),fe=ue,ce=tt.parse.bind(tt);tt.parse=t=>ce(le(t));var Je={styles:fe,parser:tt,db:oe,renderer:ae};export{Je as diagram};
//# sourceMappingURL=sankeyDiagram-QLVOVGJD-S6PY23HH.min.js.map
